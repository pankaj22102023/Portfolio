...
export const aboutData = {
    mainData: {
        ...
        description: "Detail-oriented professional with over more than 2 years in web development and 4 years in healthcare & consulting. Skilled in customer service, networking, and problem-solving. Proficient in MERN Stack and Next.js as a Full Stack Developer.",
        yearsOfExperience: "2",
        hoursOfWorking: "5",
        projectsDone: "50",
